...
const DefaultLayout = () => {
  ...
  */
  ...
  const sideBarLoggedIn = (
    <div
      className={`col-md-3 col-lg-2 d-none d-md-block bg-light sidebar full-height-sidebar container-fluid`}
    >
      <ul className="nav flex-column flex-fill d-flex flex-column justify-content-center text-center">
        ...
        <li className="nav-item">
          <NavLink
            ...
            style={{
              ...(location.pathname === "/dashboard" && navLinkActiveStyle),
            }}
          >
        ...
        <li className="nav-item">
          <NavLink
            ...
            style={{
              ...(location.pathname === "/commands" && navLinkActiveStyle),
            }}
          >
        ...
        <li className="nav-item">
          <NavLink
            to="/configurations"
            className={`nav-link ${
              location.pathname === "/configurations" ? "active" : ""
            }`}
            style={{
      ...
      <ul className="nav flex-column flex-fill d-flex flex-column justify-content-center text-center">
        ...
        <li className="nav-item">
          <NavLink
            ...
            style={{
              ...(location.pathname === "/login" && navLinkActiveStyle),
            }}
          >
        ...
        <li>
          <NavLink
            ...
            style={{
              ...(location.pathname === "/register" && navLinkActiveStyle),
            }}
          >
