      ...
      <main id="main" className="text-center">
        ...
        <section id="main_command_section">
          <aside id="command_page_titles">
            <h1 id="command_h1_title">{commandName} command</h1>
            <h3 id="command_h2_title">View the command parameters below:</h3>
          </aside>
          ...
          <Container>
            <Row className="my-2 text-start">
              <Col xs={12} md={6} className="my-2">
                <FormGroup>
                  <FormLabel className="command_name_input_label">
                    Command name
                  </FormLabel>
                  <FormControl
              ...
              <Col xs={12} md={6} className="my-2">
                <FormGroup>
                  <FormLabel className="command_description_label">
                    Command description
                  </FormLabel>
                  <FormControl
                    id="profile_email"
            ...
            <Row className="my-2 text-start">
              <Col xs={12} md={6} className="my-2 w-100">
                <FormGroup>
                  <FormLabel className="command_functionality_label">
